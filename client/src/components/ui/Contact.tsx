...
export default function Contact() {
  ...
  return (
    <section className="py-20 px-8 max-w-5xl mx-auto border-t border-neutral-800" id="contacto">
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="w-full md:w-1/2">
          ...
          <p className="text-gray-400 mb-8 leading-relaxed text-sm">
            ¿Tienes un proyecto en mente o estás buscando un desarrollador para tu equipo? 
          ...
          <div className="flex items-center gap-4 text-gray-300">
            ...
            <div>
              <p className="text-xs text-gray-500 font-mono mb-1">Correo Electrónico</p>
        ...
        <div className="w-full md:w-1/2 bg-card p-8 rounded-xl border border-neutral-800 shadow-xl">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div>
              <label htmlFor="name" className="block text-xs text-gray-400 font-mono mb-2">Nombre</label>
              <input 
                type="text" 
                id="name"
                required
            ...
            <div>
              <label htmlFor="email" className="block text-xs text-gray-400 font-mono mb-2">Email</label>
              <input 
                type="email" 
                id="email"
                required
            ...
            <div>
              <label htmlFor="message" className="block text-xs text-gray-400 font-mono mb-2">Mensaje</label>
              <textarea 
                id="message"
                required
                rows={4}
            ...
            >
              ...
              {status === 'error' && <><AlertCircle size={18} /> Hubo un error</>}
            </button>
          </form>
        </div>
